...
links:
  ...
  - name: Cloud Deployment
    ...
    icon: ri:github-line
  - name: Paper Code (coming soon)
    url: https://github.com/bdpedigo/ssa-experiments
    icon: ri:github-line
  - name: Model
...
theme: device
favicon: favicon.svg
headerBackground: cell-gallery.png
...
<div class="flex gap-4">
  <div class="flex-1">
    <figure>
      ...
      <figcaption class="text-center">Caption for mesh 1.</figcaption>
    </figure>
  </div>
  <div class="flex-1">
    <figure>
      <ModelViewer src={sampleLargeMesh} alt="Sample neuron mesh" height="400px" />
      <figcaption class="text-center">Caption for mesh 2.</figcaption>
    </figure>
  </div>
</div>
