...
<div class="flex gap-4">
  <div class="flex-1">
    <figure>
      <ModelViewer src={sampleMesh} alt="Sample neuron mesh" height="400px" />
      <figcaption class="text-center">Predictions plotted on a piece of dendrite from MICrONS</figcaption>
    </figure>
  </div>
  <div class="flex-1">
    <figure>
      <ModelViewer src={sampleLargeMesh} alt="Sample neuron mesh" height="400px" />
...
All postsynaptic target predictions are publicly available via the [MICrONS CAVE](https://www.microns-explorer.org/) infrastructure (table: `synapse_target_predictions_ssa_v2`). Code for the mesh processing pipeline is available as the [**meshmash**](https://github.com/bdpedigo/meshmash) Python library. Experiment code and cloud deployment scripts are available in the linked repositories above.
...
{/* 
I want to...
- visualize the predictions in MICrONS
- query the predictions in MICrONS programatically
- run HKS feature generation and compartment prediciton on sample data in the web
- run HKS feature generation via the Python code
- apply the HKS-based classifier to computed features
- deploy this system in the cloud
 */}